...
/* @var $searchModel app\models\BillofsaleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Facturas de Venta';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="billofsale-index">
...
//            'fk_municipality',
            ...
            [
                'attribute' => 'client',
                'value' => function ($data) {
                    return $data->client0->code . ' - ' . $data->client0->account;
                }
            ],
            [
                'attribute' => 'seller',
                'value' => function ($data) {
                    return $data->seller0->code . ' - ' . $data->seller0->account;
                }
            ],
//            'reference',
            [
